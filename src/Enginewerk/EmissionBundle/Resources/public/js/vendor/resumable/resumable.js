  ...
  var Resumable = function(opts){
    ...
    var $h = {
      ...
      getTestTarget:function(params){
        var target = $.getOpt('targetChunkTestUrl');
        if(target.indexOf('?') < 0) {
          target += '?';
        } else {
          target += '&';
    ...
    function ResumableChunk(resumableObj, fileObj, offset, callback){
      ...
      $.test = function(){
        ...
        params.push(['resumableCurrentStartByte', encodeURIComponent($.startByte)].join('='));
        params.push(['resumableCurrentEndByte', encodeURIComponent($.endByte)].join('='));
        ...
        $.xhr.open('GET', $h.getTestTarget(params));
