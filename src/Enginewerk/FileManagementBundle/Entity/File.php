...
class File
{
     ...
     * Add fileBlock
     *
     * @param \Enginewerk\FileManagementBundle\Entity\FileBlock $fileBlock
     *
     * @return File
     */
    public function addFileBlock(\Enginewerk\FileManagementBundle\Entity\FileBlock $fileBlock)
    {
     ...
     * @param \Enginewerk\FileManagementBundle\Entity\FileBlock $fileBlock
     */
    public function removeFileBlock(\Enginewerk\FileManagementBundle\Entity\FileBlock $fileBlock)
    {
